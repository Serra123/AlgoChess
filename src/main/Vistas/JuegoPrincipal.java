...
public class JuegoPrincipal {
    ...
    public void iniciar(Stage stage,String jugadorUno,String jugadorDos) {
        ...
        agregarUnidadesJugadorUno.setOnAction(e->colocarUnidadesDe(this.jugadorUno,opcionesParaCrearUnidades));
    ...
    private void colocarUnidadesDe(Jugador jugadorUno, VBox opcionesParaCrearUnidades) {
        ...
        CrearUnidadEventHandler elegirOpcionSoldado = new CrearUnidadEventHandler("Soldado",tablero,opcionesParaCrearUnidades);
        opcionSoldado.setOnAction(elegirOpcionSoldado);

        Button opcionCurandero = new Button("Curandero");
        CrearUnidadEventHandler elegirOpcionCurandero = new CrearUnidadEventHandler("Curandero",tablero,opcionesParaCrearUnidades);
        opcionCurandero.setOnAction(elegirOpcionCurandero);

        Button opcionJinete = new Button("Jinete");
        CrearUnidadEventHandler elegirOpcionJinete = new CrearUnidadEventHandler("Jinete",tablero,opcionesParaCrearUnidades);
        opcionJinete.setOnAction(elegirOpcionJinete);

        Button opcionCatapulta = new Button("Catapulta");
        CrearUnidadEventHandler elegirOpcionCatapulta = new CrearUnidadEventHandler("Catapulta",tablero,opcionesParaCrearUnidades);
        ...
        HBox [] fila = new HBox[20];
         ...
         for(int i=0;i<20;i++){
             ...
             for(int j=0;j<20;j++){
                 ...
                 int finalI = i;
                 int finalJ = j;
                 casillero[i][j].setOnAction(e->informacionCasillero((Posicion) casillero[finalI][finalJ].getUserData(),infoUsuarioClickeado));
    ...
    private Posicion informacionCasillero(Posicion posicion,Label infousuarioClickeado) {
        Unidad unidad;
